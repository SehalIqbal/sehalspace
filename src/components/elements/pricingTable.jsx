...
<Card className="bg-transparent mb-4 rounded-0">
          ...
          <Card.Body >
            ...
            <ul className="list-unstyled my-4">
              <li className="px-3 py-2 border-bottom"> Cras justo odio</li>
              <li className="px-3 py-2 border-bottom"> Dapibus ac facilisis in</li>
              <li className="px-3 py-2 border-bottom"> Vestibulum at eros</li>
            </ul>
